...
Pod::Spec.new do |spec|
  ...
  这个是UNAD国外版本.的cocoapods
                   DESC

  spec.homepage     = "https://github.com/adgocompany/unad-ios-global"
  ...
  spec.source       = { :git => "https://github.com/adgocompany/unad-ios-global.git", :tag => "#{spec.version}" }
  ...
  #
   ...
   spec.resource  = "UNAD-Global/UNADBundle.bundle"
